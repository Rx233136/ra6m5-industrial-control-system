...
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf424,
  .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t) 5, .channel = 7, .p_callback = NULL,
...
{ .scan_mask = ADC_MASK_CHANNEL_1 | ADC_MASK_CHANNEL_2 | ADC_MASK_CHANNEL_3 | ADC_MASK_CHANNEL_10 | 0,
  .scan_mask_group_b = 0,
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf424,
  .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t) 5, .channel = 8, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .p_ctrl = &g_timer_gpt8_ctrl, .p_cfg = &g_timer_gpt8_cfg, .p_api = &g_timer_on_gpt };
...
{ .mode = TIMER_MODE_PWM,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf424,
  .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t) 5, .channel = 6, .p_callback = NULL,
  /** If NULL then do not add & */
#if defined(NULL)
    .p_context           = NULL,
#else
...
{ .p_ctrl = &g_timer_gpt6_ctrl, .p_cfg = &g_timer_gpt6_cfg, .p_api = &g_timer_on_gpt };
